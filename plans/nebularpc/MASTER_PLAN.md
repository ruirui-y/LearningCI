...
subtitle: "从 MyMuduo / game_rpc_project 的真实断点继续到现代 C++20 Async RPC Runtime"
author: "Living Design Document"
date: "v0.2 · 2026-09-09"
lang: zh-CN
---
...
这份文档是 NebulaRPC 的**总纲 / Master Plan**。后续所有设计修改都应优先回写到这里，或者通过 ADR（Architecture Decision Record）记录后再同步本文件。它不是一次性教程，而是一份长期维护的设计文档。
...
本文件是 Living Document。建议每次重大修改更新版本号并记录：
